...
Example of all light attacks being triggered one after the other. **L1 > L2 > L3 > L4**  
...
{% include tiles-big.html
    ...
    content="
#### Heavy Attack 1  
Example the Heavy Attack 1 if pressed by itself while in idle **H1**
"
%}
...
{% include tiles-big.html
    ...
    content="
#### Heavy Attack 2  
Example the Heavy Attack 2 if innitiated after Light Attack 1 **L1 > H2**
"
%}
...
{% include tiles-big.html
    ...
    content="
#### Heavy Attack 3  
Example the Heavy Attack 2 if innitiated after Light Attack 1 **L1 > L2 > H3**
"
%}
...
{% include tiles-big.html
    ...
    content="
#### Heavy Attack 4  
Example the Heavy Attack 2 if innitiated after Light Attack 1 **L1 > L2 > L3 > H4**
"
%}
